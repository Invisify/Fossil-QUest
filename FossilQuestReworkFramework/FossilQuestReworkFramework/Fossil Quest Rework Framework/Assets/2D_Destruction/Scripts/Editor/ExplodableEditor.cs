...
public class ExplodableEditor : Editor {
    ...
    public override void OnInspectorGUI()
    {
        ...
        myTarget.gravityScale = EditorGUILayout.FloatField("Gravity Scale", myTarget.gravityScale);
        ...
        {
            foreach (var script in myTargets)
            {
                ((Explodable)script).allowRuntimeFragmentation = allowRunTimeFragmentation;
            }
